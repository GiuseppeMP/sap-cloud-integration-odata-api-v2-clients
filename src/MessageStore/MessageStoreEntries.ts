...
import {
  ...
  MessageStoreEntryAttachmentsType
} from './MessageStoreEntryAttachments';
import {
  ...
  implements MessageStoreEntriesType<T>
{
  ...
  /**
   * One-to-many navigation property to the {@link MessageStoreEntryAttachments} entity.
   */
  declare attachments: MessageStoreEntryAttachments<T>[];
  /**
...
> {
  ...
  attachments: MessageStoreEntryAttachmentsType<T>[];
